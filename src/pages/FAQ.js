                  ...
                  <span className="text-justify text-center">
                    ...
                    <ul>
                      <li>
                        ...
                        <b>Live Activity:</b>
                        <br />
                        First, you have to label your activity into a category:{" "}
                        <br />
                        Productive / Neutral / Unproductive
                        <br />
                        <br />
                        There's a Stopwatch for you to track your current
                        activity. When you're done, just press save and send the
                        activity data to our Server.
                        <br />
                        Alternatively, you can youse a Counter.
                        <br />
                        Just specify how long <i>ActivityName</i> took and how
                        often you've done it. The total duration gets calculated
                        for you. When you're done, just send the activity data
                        to our Server.
                      </li>
                      <li>
                        <br />
                        ...
                        place and you have full control over what data is being
                        used (e.g. date / total duration)
                      </li>
                    </ul>
                  </span>
                </details>
                <details className="mb-4">
                  ...
                  <span className="text-justify text-center">
                    <p>
                      ...
                      like a fine wine: the more it matures, the more awesome it
                      gets. In other words: the more activitíes you enter, the
                      better the overview about your productiveness will get.
                      <br />
                      <br />
                ...
                <details className="mb-4">
                  ...
                  <span className="text-justify text-center">
                    <p>
                      ...
                      personal Overview. Once set up, you just have to click on
                      the plus-icon and they automatically get tracked.
                    </p>
                  </span>
                </details>
                <details className="mb-4">
