...
class QuickActivitySettings extends Component {
  ...
  render() {
    console.log(this.state.productivityType);
              ...
              {this.state.quickActivities ? (
                this.state.quickActivities.map((quickActivity) => (
                  <div className="flex flex-col w-auto mb-4">
                    ...
                    <button
                      type="button"
                      onClick={() => this.deleteQuickActivity(quickActivity.id)}
                    >
              ...
              <Label>
                ...
                <Input
                  ...
                  placeholder={`How long do you usually do ${
                    this.state.activityName ? this.state.activityName : "(Name)"
                  } for (in minutes)?`}
                  value={this.state.activityDuration}
                  onChange={this.handleInput}
                  valid={this.validateNumbersOnly(this.state.activityDuration)}
                />
              </Label>
